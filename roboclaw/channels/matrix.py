...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install roboclaw-ai[matrix]"
    ) from e
...
from roboclaw.config.paths import get_data_dir, get_media_dir
from roboclaw.config.schema import Base
from roboclaw.utils.helpers import safe_filename
